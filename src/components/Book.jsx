...
const Book = () => {
  return (
    <>
    {
        bookImages.map((bookImage)=>(

            <div className='w-[330px] shadow-md hover:shadow-xl rounded-md h-60 hover:scale-105 ease-in-out duration-200 flex flex-col p-2 gap-3 border-gray-100 border-2'>
